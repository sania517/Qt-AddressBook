...
QtObject {
    ...
    readonly property color buttonColor: isDarkTheme ? "darkgray" : "darkgray"
    ...
    readonly property int defaultTextSize: 13
    readonly property int largeTextSize: 18
    readonly property int smallTextSize: 9
